...
Для Windows:
    ...
    Установите библиотеки: pip install discord.py aiosqlite python-dotenv
...
For Windows:
    ...
    Open terminal (PowerShell or CMD) in the project folder.

    Create environment: python -m venv venv

    Activate: .\venv\Scripts\activate

    Install libraries: pip install discord.py aiosqlite python-dotenv
